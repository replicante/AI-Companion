# AI-Companion
Minimalist AI assistant plasmoid for KDE Plasma 6 — Claude, Gemini, ChatGPT, Grok, Qwen, Ollama, llama.cpp and more, with streaming, chat history, file attachments and web search.
